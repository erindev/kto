...
<?php
	...
	$sql = "select * from notice where tno='$no'";
 ...
 <div class="subMain" id="main">
		...
		<div class="container">
			<div class="contBody">
				...
				<div class="container">
					<form action="./notice_edit.php?no=<?=$no?>" method="post">
			<table id="peopleTable"  class="list">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="title" id="title" value="<?=$row['ttitle']?>"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="date" id="date" rows="5" cols="56" value="<?=$row['tdate']?>"/></td>
					</tr>
					<tr>
						<th scope="row"><label for="content">내용</label></th>
						<td><textarea name="content" id="content" rows="5" cols="56"><?=$row['tcont']?></textarea></td>
					</tr>
					<tr class="menubars">
						<th colspan="2">
