...
<?php
	...
	$sql = "select * from food nature ano='$no'";
 ...
 <div class="subMain" id="main">
		...
		<div class="container">
			<div class="contBody">
				...
				<div class="container">
					<form action="./adventure_edit.php?no=<?=$no?>" method="post">
			<table id="peopleTable"  class="list">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="title" id="title" value="<?=$row['vtitle']?>"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea name="content" id="content" rows="5" cols="56"><?=$row['vcont']?></textarea></td>
					</tr>
					<tr class="menubars">
						<th colspan="2">
