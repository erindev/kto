...
<?php
	...
	$sql = "select * from stay where sno='$no'";
		...
		<div class="container">
			<div class="contBody">
				...
				<div class="contArea">
					...
					<form action="./stay_edit.php?no=<?=$no?>" method="post">
			<table id="peopleTable"  class="list">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="title" id="title" value="<?=$row['stitle']?>"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea name="content" id="content" rows="5" cols="56"><?=$row['scont']?></textarea></td>
					</tr>
					<tr class="menubars">
						<th colspan="2">
