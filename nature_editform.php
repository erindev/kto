 ...
 <div class="subMain" id="main">
		...
		<div class="koreaTravel">
			<div class="container">
				...
				<div class="container">
					<form action="./nature_edit.php?no=<?=$no?>" method="post">
			<table id="peopleTable"  class="list">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" name="title" id="title" value="<?=$row['atitle']?>"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea name="content" id="content" rows="5" cols="56"><?=$row['acont']?></textarea></td>
					</tr>
					<tr class="menubars">
						<th colspan="2">
