...
<?php
	...
	$mysql = "select * from nature where ano='$detail'";
...
-->
				...
				<div class="conatainer">
					...
					if ( $_SESSION['userid'] == "admin" ){ ?>
							<li><a href="./nature_editform.php?no=<?=$detail?>">[수정하기]</a></li>
							<li><a href="./nature_deleteform.php?no=<?=$detail?>">[삭제하기]</a></li>
