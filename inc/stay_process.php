<?php
	...
	$target_dir = "stay_uploads/"; // 올릴파일이름잡기
	...
	$sql = "insert into stay
			(stitle,scity,scont, simage,spart)
			values ('$stitle','$scity','$scont','$target_file','$spart')";

	$result = mysqli_query($con, $sql) or die (mysqli_error($con));

	if ( $result ) { echo "<script>alert('[숙소]글쓰기가 성공했습니다');</script>"; } //07

	$sqlno = "select * from stay where 'stitle'='$stitle'";
