...
require '/php-graph-sdk-5.0.0/src/Facebook/Facebook.php';
//require_once './php-graph-sdk-5.0.0/src/Facebook/autoload.php';
	
define('107492893264148','107492893264148');
...
//  'secret' => '1f28d4956ac7d25321e0298ca9a780de'
//));
...
<head>
	...
	<!--    favicon-->
	<!--    <link href="32px" rel="shortcut icon"/> 안드로이드-->
	<!--    <link href="32px" rel="apple-touch-icon"/> iPhone-->
	<!--
    <link href="16" rel="icon"/>
    <link href="32" rel="icon"/>
    <link href="48" rel="icon"/>
    <link href="64" rel="icon" />
    <link href="128" rel="icon"/>
    <link href="256" rel="icon"/>
    <link href="512" rel="icon" />
-->
					...
					<ul class="gnb gnbGeneral" id="gnb">
						...
						<li class="search">
							...
							<div class="searchLayer">
								<form action="#" name="menuSearch" method="post" id="searchForm">
									<fieldset>
										<legend>통합검색</legend>
