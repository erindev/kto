...
<?php include_once "./inc/fn_util.php"; myTitle("회원가입 | 한국관광공사"); ?>
		<!-- #header END-->
	<section id="main">
		<div class="container">
			<h3 class="join">회원가입</h3>
			<p class="desc">회원 유형에 따라 가입 절차가 다르니 고객님께 해당하는 유형을 선택해주세요.</p>
			<ul class="fourstep">
				<li>1단계<span>회원분류선택</span></li>
				<li>2단계<span>가입약관동의</span></li>
				<li>3단계<span>회원정보입력</span></li>
				<li>4단계<span>회원가입완료</span></li>
			</ul>
			<ul class="step st1">
				<li><a href="#" title="개인 회원가입"><span>개인</span>회원가입<p>만 14세 이상 내국인</p></a></li>
				<li><a href="#" title="어린이/학생 회원가입"><span>어린이 학생</span>회원가입<p>만 14세 이상 내국인</p></a></li>
				<li><a href="#" title="개인 회원가입"><span>개인</span>회원가입<p>만 14세 이상 내국인</p></a></li>
				<li><a href="#" title="기업 회원가입"><span>기업</span>회원가입<p>국내외 기업 대상</p></a></li>
			</ul>
			<div class="step st2">
				<h4 class="join">가입약관동의</h4>
				<p class="desc">서비스 약관 및 개인정보 수집, 이용에 <span>동의</span>해주세요.</p>
				<form action="#" method="post" id="join">
					<fieldset>
						<legend>VisitKorea 회원 이용약관</legend>
						<textarea disabled rows="25">
                            제 1 장 총 칙
                            제 1 조 목적
						...
						<p><input type="checkbox" name="agree1" id="agree1" title="서비스 약관 동의 체크박스" /><label for="agree1">동의하기</label></p>
					</fieldset>
					<fieldset>
						<legend>개인정보 수집/활용이용에 관한 동의</legend>
						<textarea disabled rows="25">
                            제 1 장 총 칙
                            제 1 조 목적
                            본 약관은 서비스 이용자가 주식회사 카카오(이하 “회사”라 합니다)가 제공하는 온라인상의 인터넷 서비스(이하 “서비스”라고 하며, 접속 가능한 유∙무선 단말기의 종류와는 상관없이 이용 가능한 “회사”가 제공하는 모든 “서비스”를 의미합니다. 이하 같습니다)에 회원으로 가입하고 이를 이용함에 있어 회사와 회원(본 약관에 동의하고 회원등록을 완료한 서비스 이용자를 말합니다. 이하 “회원”이라고 합니다)의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.
						...
						<p><input type="checkbox" id="agree2" name="agree2" title="개인정보 수집 및 이용 동의 체크박스" /><label for="agree2">동의하기</label></p>
						<p class="star">※ 위 개인정보 수집.이용에 관한 동의는 회원가입에 필수적이므로 이에 동의하셔야 이후 절차를 진행할 수 있습니다. 수집에 동의하지 않으시는 경우 공사에서 제공하는 관광정보 지킴이, 관광서비스 제공, 관광정보사용신청등의 서비스에 제한이 있을 수 있습니다.</p>
						<p><input type="radio" title="개인정보 수집 및 이용 동의 체크박스" id="all_check" name="all_check" /><label for="all_check">전체 필수 약관 및 이용 제공에 동의합니다</label></p>
					</fieldset>
					<div class="real_check">
						<!--이부분은 체크박스 두개 다 체크하자마자 뿅 하고 '동의하기'버튼 위에 나타나게-->
						<p>공사에서는 개인정보의 유출 및 도용, 익명 사용자로 인한 피해 등을 방지하고 본인확인절차를 진행하기 위하여 휴대폰 인증 및 아이핀 인증 서비스를 실시합니다.</p>
						<ul>
							<li><img src="#" alt="" /><b>휴대폰인증</b><span>※ 메시지 수신 가능한 휴대폰으로 인증번호를 받으실 수 있습니다.</span>
								<p><input type="button" value="휴대폰 인증" /></p>
							</li>
							<li><img src="#" alt="" /><b>아이핀 (i-Pin) 인증</b><span>※ 아이핀 (i-Pin) 이란? 인터넷 상에서 주민등록번호를 대신하여 본인임을 확인 받을 수 있는 사이버 신원 확인번호입니다.</span>
								<p><input type="button" value="아이핀 인증" /></p>
							</li>
						</ul>
					</div>
					<fieldset>
						<p><input type="submit" id="submit2" value="동의하기" title="최종 동의하기 버튼" />
						</p>
					</fieldset>
				</form>
			</div>
			<div class="step st3">
				<h4>회원정보입력</h4>
				<p><span class="star">(*)</span> 표시는 필수입력사항입니다.</p>
				<form action="./inc/join_process.php" id="st3" method="post">
					<fieldset>
						<legend>회원정보입력</legend>
						<p>
						<label for="username"><span class="star">(*)</span> 성명</label><input type="text" id="username" name="username" />
						</p>
							<p>
							<label for="userid"><span class="star">(*)</span> 아이디</label><input type="text" id="userid" name="userid" /><input type="button" value="아이디 중복확인" id="id_validate" /><span class="exspan">(아이디는 4~12 자리의 영문소문자, 숫자만 사용하실 수 있습니다.)</span>
							</p>
							<p>
							<label for="userpass"><span class="star">(*)</span> 패스워드</label><input type="password" id="userpass" name="userpass" />
							<span class="exspan">(비밀번호는 8~18자리의 영문대문자, 영문소문자, 숫자, 특수문자를 3종류 이상 혼합해야 합니다.)</span>
							</p>
							<p><label for="userpass2"><span class="star">(*)</span> 패스워드 재입력</label><input type="password" id="userpass2" name="userpass2" />
							</p>
							<p>
							...
							<select id="emailaddress" name="emailaddress">
                                ...
                                <option value="nate.com"> 직접입력</option>
                                <option value="yahoo.com">야후</option>
                            </select>
							</p>
							<p>
								<label for="phone1"><span class="star">(*)</span> 휴대폰번호</label>
								<input type="text" id="phone1" name="phone1" /> -
								<input type="text" id="phone2" name="phone2" /> -
								<input type="text" id="phone3" name="phone3">
							</p>
							<p class="radio">
								<label><span class="star">(*)</span> SMS수신여부</label>
								<input type="radio" checked value="Y" id="yes" name="sms"/>
								<label for="yes">예</label><input type="radio" value="N" id="no" name="sms"/>
							...
							<p class="detailAddress">
								...
								<input type="text" id="address" name="address" /> - <input type="text" id="address2" name="address2" />
								<span class="exspan">(입력해주신 주소는 경품 수령시에만 참고합니다.)</span>

							</p>
							<p>
								<input type="button" value="이전" id="prevbtn"/>
								<input type="submit" value="회원가입"/>
								<input type="reset" value="다시쓰기" id="join_cancle"/>
							</p>
					</fieldset>
				</form>
			</div>
			...
			<thead>
				<tr>	<th scope="col" id="title">Title</th><th scope="col" id="content">Content</th></tr>
			</thead>
			<tbody>
			<?php
				$userid = $_GET['userdata'];
				
				$sql = "select * from kto_members where userid='$userid'";
				$result = mysqli_query ( $con, $sql ) or die (mysqli_error($con));
				$row = mysqli_fetch_array ( $result, MYSQLI_ASSOC);
				
			?>
				<tr><th id="s4userid">아이디</th><td><?=$row['userid']; ?></td></tr>
				<tr><th id="s4username">이름</th><td><?=$row['username'];?></td></tr>
				<tr><th id="s4useremail">이메일</th><td><?=$row['useremail'];?></td></tr>
				<tr><th id="usercall">PHONE</th><td><?=$row['userphone'];?></td></tr>
				<tr><th id="joindate">가입날짜</th><td><?=$row['joindate'];?></td></tr>
			</tbody>
		</table>
			</div>
			<div class="join_description">
				<p><a href="./login.php">로그인하러가기</a></p>
				<ul>
